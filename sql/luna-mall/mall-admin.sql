/*
 ...
 Source Schema         : mall-admin

 Target Server Type    : MySQL
 Target Server Version : 50734
 File Encoding         : 65001

 Date: 08/06/2021 19:43:18
*/
...
-- ----------------------------
BEGIN;
INSERT INTO `qrtz_scheduler_state` VALUES ('RenrenScheduler', 'lunas-mac.local1623137715412', 1623144098321, 15000);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `qrtz_triggers` VALUES ('RenrenScheduler', 'TASK_1', 'DEFAULT', 'TASK_1', 'DEFAULT', NULL, 1623144600000, 1623142800000, 5, 'WAITING', 'CRON', 1590919162000, 0, NULL, 2, );
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=317 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='定时任务日志';
...
INSERT INTO `schedule_job_log` VALUES (308, 1, 'testTask', 'fireflynay', 0, NULL, 9, '2021-06-05 22:30:00');
INSERT INTO `schedule_job_log` VALUES (309, 1, 'testTask', 'fireflynay', 0, NULL, 1, '2021-06-08 09:30:00');
INSERT INTO `schedule_job_log` VALUES (310, 1, 'testTask', 'fireflynay', 0, NULL, 1, '2021-06-08 10:00:00');
INSERT INTO `schedule_job_log` VALUES (311, 1, 'testTask', 'fireflynay', 0, NULL, 0, '2021-06-08 10:30:00');
INSERT INTO `schedule_job_log` VALUES (312, 1, 'testTask', 'fireflynay', 0, NULL, 2, '2021-06-08 11:00:00');
INSERT INTO `schedule_job_log` VALUES (313, 1, 'testTask', 'fireflynay', 0, NULL, 0, '2021-06-08 11:30:00');
INSERT INTO `schedule_job_log` VALUES (314, 1, 'testTask', 'fireflynay', 0, NULL, 0, '2021-06-08 16:00:00');
INSERT INTO `schedule_job_log` VALUES (315, 1, 'testTask', 'fireflynay', 0, NULL, 1, '2021-06-08 16:30:00');
INSERT INTO `schedule_job_log` VALUES (316, 1, 'testTask', 'fireflynay', 0, NULL, 1, '2021-06-08 17:00:00');
COMMIT;
...
INSERT INTO `sys_captcha` VALUES ('a4b17ee4-87d6-4c92-8be4-f5319fab84ff', '47yna', '2021-06-05 22:40:56');
...
INSERT INTO `sys_captcha` VALUES ('fc22d01d-09d4-4477-89da-f908e595e780', 'cf738', '2021-06-08 15:42:12');
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='系统配置信息表';
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='系统日志';
...
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='菜单管理';
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user_token` VALUES (1, '1f26591137f06545b4d4c57acc986a8c', '2021-06-08 21:16:22', '2021-06-08 09:16:22');
COMMIT;
