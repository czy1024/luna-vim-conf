...
CREATE TABLE `ums_member` (
  ...
  `social_uid` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '社交账号ID',
  `access_token` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '社交账号Token',
  `expires_in` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '社交账号Token过期时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='会员';
