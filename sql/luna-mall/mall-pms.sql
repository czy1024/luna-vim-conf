...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='品牌';

-- ----------------------------
-- Records of pms_brand
-- ----------------------------
BEGIN;
INSERT INTO `pms_brand` VALUES (1, '荣耀', 'https://luna97.oss-cn-beijing.aliyuncs.com/2021-06-08/8d97f16f-98a0-4594-8971-7621f47c6d9b_cat_1.jpg', '优秀', 1, 'r', 0);
...
INSERT INTO `pms_brand` VALUES (6, 'huawei', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `pms_brand` VALUES (7, '锤子', 'https://luna97.oss-cn-beijing.aliyuncs.com/2021-06-08/7c1f6a40-151e-4350-8863-66e36f7355bf_cat.jpg', '锤子手机', 1, 'c', 0);
COMMIT;
